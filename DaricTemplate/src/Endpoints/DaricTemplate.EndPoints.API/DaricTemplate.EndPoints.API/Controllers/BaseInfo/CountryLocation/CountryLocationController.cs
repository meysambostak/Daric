using Daric.EndPoints.Web.Core.Controllers;
...
public class CountryLocationController : BaseController
{
    ...
    [HttpGet("[action]")]
    public async Task<IActionResult> GetCountryLocationById([FromQuery] GetByIdQuery<CountryLocationDto> query)
        => await Query<GetByIdQuery<CountryLocationDto>, CountryLocationDto>(query);
