...
using DaricTemplate.Infra.Data.Queries.BaseInfo.CountryLocations;

using Microsoft.EntityFrameworkCore;

namespace DaricTemplate.Infra.Data.Queries.Context;

 
public partial class DaricTemplateQueryDbContext : BaseQueryDbContext
{
    public DaricTemplateQueryDbContext(DbContextOptions<DaricTemplateQueryDbContext> options)
        : base(options)
    {
    }

    public virtual DbSet<CountryLocation> CountryLocations { get; set; } = null!;
